...
public class Constants {
    public static final String ADDRESS = "http://192.168.1.175:8080/";
    public static final String USER_LOGIN_URL = ADDRESS + "user/login";
    public static final String USER_OWN_URL = ADDRESS + "user/own/";
